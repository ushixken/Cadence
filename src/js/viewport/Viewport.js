...
function createObjectMeasurementCommandSession(name,{preselectionIds=[]}={}){
  const specs={Length:{types:new Set(["line","circle","arc","polyline"]),fields:{line:"length",circle:"circumference",arc:"arcLength",polyline:"length"}},Radius:{types:new Set(["circle","arc"]),fields:{circle:"radius",arc:"radius"}},Diameter:{types:new Set(["circle","arc"]),fields:{circle:"diameter",arc:"diameter"}},Area:{types:new Set(["circle","ellipse","polyline","region"]),fields:{circle:"area",ellipse:"area",polyline:"area",region:"area"}},Perimeter:{types:new Set(["circle","polyline","region"]),fields:{circle:"perimeter",polyline:"perimeter",region:"perimeter"}}},spec=specs[name]
