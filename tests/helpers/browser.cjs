...
async function browser({ commands = true, realRenderer = false, gpu } = {}) {
  ...
  const layersTab=new Element('button'),groupsTab=new Element('button'),propertiesTab=new Element('button'),layersView=new Element('section'),groupsView=new Element('section'),propertiesView=new Element('section'),propertiesContent=new Element();
  const groupsList=new Element(),groupCreateButton=new Element('button');layersTab.hidden=false;groupsTab.hidden=false;propertiesTab.hidden=false;layersView.hidden=false;groupsView.hidden=true;propertiesView.hidden=true;propertiesContent.hidden=false;
  ...
  for (const el of [layersList,layerCreateButton,layerAssignButton,layerUnisolateButton,groupsList,groupCreateButton,layersTab,groupsTab,propertiesTab,layersView,groupsView,propertiesView,propertiesContent,contextMenu,gridSnapButton,orthoButton,polarButton,trackButton]) { el.parent=document; el.owner=document; }
  propertiesContent.parent=propertiesView;layersList.parent=layersView;groupsList.parent=groupsView;
