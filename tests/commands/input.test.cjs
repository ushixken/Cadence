...
test('registry is the single deterministic autocomplete and routing source', async () => {
  ...
  assert.deepEqual(b.read('window.caderactCommandRegistry.commands().map(command=>({name:command.name,aliases:command.aliases}))'), [
    { name: 'Aligned', aliases: ['DIMALIGNED', 'DAL'] }, { name: 'Angle', aliases: ['ANG'] }, { name: 'Angular', aliases: ['DIMANGULAR', 'DAN'] }, { name: 'Arc', aliases: ['A'] }, { name: 'Area', aliases: [] }, { name: 'Block', aliases: ['B'] }, { name: 'BlockEdit', aliases: ['BE'] }, { name: 'Circle', aliases: ['C'] }, { name: 'Copy', aliases: ['CP'] }, { name: 'Delete', aliases: ['DEL', 'E', 'ERASE'] }, { name: 'Diameter', aliases: ['DIA'] }, { name: 'DimDiameter', aliases: ['DDI'] }, { name: 'DimRadius', aliases: ['DRA'] }, { name: 'Distance', aliases: ['DI', 'DIST'] }, { name: 'DistanceObject', aliases: ['DOBJ'] }, { name: 'DistanceSum', aliases: ['DSUM'] }, { name: 'Ellipse', aliases: ['EL'] }, { name: 'Explode', aliases: ['X'] }, { name: 'Extend', aliases: ['EX'] }, { name: 'Hatch', aliases: ['H'] }, { name: 'Insert', aliases: ['I'] }, { name: 'Length', aliases: ['LEN'] }, { name: 'Line', aliases: ['L'] }, { name: 'Linear', aliases: ['DIMLINEAR', 'DLI'] }, { name: 'MinDist', aliases: [] }, { name: 'Mirror', aliases: ['MI'] }, { name: 'Move', aliases: ['M'] }, { name: 'Offset', aliases: ['O'] }, { name: 'Perimeter', aliases: ['PERIM'] }, { name: 'Polygon', aliases: ['PG'] }, { name: 'Polyline', aliases: ['Pline', 'PL'] },
