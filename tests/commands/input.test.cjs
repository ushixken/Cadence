...
test('registry is the single deterministic autocomplete and routing source', async () => {
  const b = await browser();
  assert.deepEqual(b.read('window.caderactCommandRegistry.commands().filter(command=>!["ArcLength","CenterLine","CenterMark","DimBaseline","DimContinue","Ordinate","Leader","MLeader"].includes(command.name)).map(command=>({name:command.name,aliases:command.aliases}))'), [
    { name: 'Align', aliases: ['AL'] }, { name: 'Aligned', aliases: ['DIMALIGNED', 'DAL'] }, { name: 'Angle', aliases: ['ANG'] }, { name: 'Angular', aliases: ['DIMANGULAR', 'DAN'] }, { name: 'Arc', aliases: ['A'] }, { name: 'Area', aliases: [] }, { name: 'Block', aliases: ['B'] }, { name: 'BlockEdit', aliases: ['BE'] }, { name: 'Break', aliases: ['BR'] }, { name: 'Chamfer', aliases: ['CHA'] }, { name: 'Circle', aliases: ['C'] }, { name: 'Copy', aliases: ['CP'] }, { name: 'CrossingPolygon', aliases: ['CPOLY'] }, { name: 'Delete', aliases: ['DEL', 'E', 'ERASE'] }, { name: 'Diameter', aliases: ['DIA'] }, { name: 'DimDiameter', aliases: ['DDI'] }, { name: 'DimRadius', aliases: ['DRA'] }, { name: 'Distance', aliases: ['DI', 'DIST'] }, { name: 'DistanceObject', aliases: ['DOBJ'] }, { name: 'DistanceSum', aliases: ['DSUM'] }, { name: 'Ellipse', aliases: ['EL'] }, { name: 'Explode', aliases: ['X'] }, { name: 'Extend', aliases: ['EX'] }, { name: 'Fence', aliases: [] }, { name: 'Fillet', aliases: ['F'] }, { name: 'Hatch', aliases: ['H'] }, { name: 'Insert', aliases: ['I'] }, { name: 'Join', aliases: ['J'] }, { name: 'Length', aliases: ['LEN'] }, { name: 'Lengthen', aliases: ['LENG'] }, { name: 'Line', aliases: ['L'] }, { name: 'Linear', aliases: ['DIMLINEAR', 'DLI'] }, { name: 'MinDist', aliases: [] }, { name: 'Mirror', aliases: ['MI'] }, { name: 'Move', aliases: ['M'] }, { name: 'Offset', aliases: ['O'] },
    { name: 'PathArray', aliases: ['ARRAYPATH'] }, { name: 'Perimeter', aliases: ['PERIM'] }, { name: 'PolarArray', aliases: ['ARRAYPOLAR'] }, { name: 'Polygon', aliases: ['PG'] }, { name: 'Polyline', aliases: ['Pline', 'PL'] },
    { name: 'Radius', aliases: ['RAD'] }, { name: 'Rectangle', aliases: ['Rect'] }, { name: 'RectangularArray', aliases: ['ARRAYRECT', 'AR'] }, { name: 'Region', aliases: ['REG'] }, { name: 'Rotate', aliases: ['RO'] }, { name: 'Scale', aliases: ['SC'] }, { name: 'SelectByLayer', aliases: ['SELLAYER'] }, { name: 'SelectByType', aliases: ['SELTYPE'] }, { name: 'SelectSimilar', aliases: [] }, { name: 'Split', aliases: ['SPL'] }, { name: 'Stretch', aliases: ['S'] }, { name: 'Text', aliases: ['DTEXT'] }, { name: 'Trim', aliases: ['TR'] }, { name: 'WindowPolygon', aliases: ['WP'] },
  ]);
  assert.deepEqual(b.read('window.caderactCommandRegistry.matches("Li").map(command=>command.name)'), ['Line','Linear']);
