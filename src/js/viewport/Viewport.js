...
function createLinearDimensionCommandSession({setPrompt=()=>{}}={}){
  const draft=window.CaderactLinearDimensionDraftSession.create({createRecord:recordGateway.createLinearDimension,commitRecords:recordGateway.createAll})
