...
Hover/preselection, grips and editing, pickbox, window/crossing selection, cycling, filters, Select All/invert, Delete, transforms, Properties, object layer reassignment UI, selection sets, advanced snapping, other geometry types, and 3D selection remain deferred.
