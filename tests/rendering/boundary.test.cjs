...
test('viewport submits ordered scene groups; scene buffers cannot modify model', async () => {
  ...
  assert.deepEqual(Array.from(scene.lineGroups, g => g.color), [
    'rgba(167, 175, 187, 0.28)', 'rgba(167, 175, 187, 0.45)', '#984b51', '#3b7658', '#e8edf4', '#e8edf4', 'rgba(232, 237, 244, 0.65)', '#63b7e6', '#e8edf4', '#f2cf72', '#63b7e6', '#e8edf4', 'rgba(75, 155, 210, 0.10)', 'rgba(78, 170, 112, 0.10)', '#63b7e6', '#70c58b', '#f2cf72', 'rgba(160, 177, 193, 0.35)', 'rgba(242, 207, 114, 0.72)', '#f2cf72', 'rgba(157, 200, 239, 0.90)', '#63b7e6', 'rgba(111, 190, 210, 0.48)', 'rgba(111, 190, 210, 0.82)',
  ]);
