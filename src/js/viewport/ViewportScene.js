    ...
    function createScene() {
      ...
      if (gripPreview) {
        if (gripPreview.type === "line") {
          ...
          const presentation=window.CaderactDimensionGeometry.derive(gripPreview,getDimensionStyle(),{length:getDocumentUnit()})
