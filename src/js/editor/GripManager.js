(() => {
  ...
  const geometryAdapter = Object.freeze({
    ...
    target(record) { return record?.type === "line" ? lineAdapter : record?.type === "polyline" ? polylineAdapter : record?.type==="text"?textAdapter:record?.type==="region"||record?.type==="hatch"?regionAdapter:record?.type?.startsWith("dimension-")?dimensionAdapter:null },
