...
test('registry is the single deterministic autocomplete and routing source', async () => {
  ...
  assert.deepEqual(b.read('window.caderactCommandRegistry.commands().map(command=>({name:command.name,aliases:command.aliases}))'), [
    { name: 'Arc', aliases: ['A'] }, { name: 'Area', aliases: [] }, { name: 'Circle', aliases: ['C'] }, { name: 'Copy', aliases: ['CP'] }, { name: 'Delete', aliases: ['DEL', 'E', 'ERASE'] }, { name: 'Diameter', aliases: ['DIA'] }, { name: 'Distance', aliases: ['DI', 'DIST'] }, { name: 'Ellipse', aliases: ['EL'] }, { name: 'Extend', aliases: ['EX'] }, { name: 'Length', aliases: ['LEN'] }, { name: 'Line', aliases: ['L'] }, { name: 'Mirror', aliases: ['MI'] }, { name: 'Move', aliases: ['M'] }, { name: 'Offset', aliases: ['O'] }, { name: 'Perimeter', aliases: ['PERIM'] }, { name: 'Polygon', aliases: ['PG'] }, { name: 'Polyline', aliases: ['Pline', 'PL'] },
