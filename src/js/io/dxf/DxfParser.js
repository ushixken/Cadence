...
(() => {
  ...
  const neutralBase = entity => ({ type: entity.type, handle: entity.handle || null, layer: first(entity, 8)?.value?.trim() || "0", sourceIndex: entity.sourceIndex })
  function parseLine(entity, collector) {
    ...
    return Object.freeze({ ...neutralBase(entity), start: Object.freeze({ x: x1, y: y1 }), end: Object.freeze({ x: x2, y: y2 }) })
  }
  function parseLwPolyline(entity, collector) {
    ...
    return Object.freeze({ ...neutralBase(entity), closed, vertices: Object.freeze(vertices.map(vertex => Object.freeze({ x: vertex.x, y: vertex.y }))) })
  }
  function parseLegacyPolyline(entity, vertices, collector) {
    ...
    return Object.freeze({ ...neutralBase(entity), closed, vertices: Object.freeze(points) })
  }
  function parseCircle(entity, collector) {
    ...
    return Object.freeze({ ...neutralBase(entity), center: Object.freeze({ x, y }), radius })
  }
  function parseArc(entity, collector) {
    ...
    return Object.freeze({ ...neutralBase(entity), center: Object.freeze({ x, y }), radius, startAngleDegrees, endAngleDegrees })
  }
  function parseEllipse(entity, collector) {
    ...
    return Object.freeze({ ...neutralBase(entity), center: Object.freeze({ x, y }), majorAxis: Object.freeze({ x: majorX, y: majorY }), ratio, startParameter, endParameter })
  }
